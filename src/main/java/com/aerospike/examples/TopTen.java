...
public class TopTen {
	...
	public TopTen(String host, int port, String namespace, String set) throws AerospikeException {
	...
	public TopTen(AerospikeClient client, String namespace, String set) throws AerospikeException {
		this.client = client;
		this.namespace = namespace;
		this.set = set;
		this.writePolicy = new WritePolicy();
